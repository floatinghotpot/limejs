 ...
 * @extends lime.Button
 */
benchmark.Button = function(txt) {
    lime.GlossyButton.call(this, txt);

    this.borderWidth = 4;
    this.setColor('#000');
};
goog.inherits(benchmark.Button, lime.GlossyButton);

/**
 * @inheritDoc
 */
benchmark.Button.prototype.makeState_ = function() {
 ...
 * @inheritDoc
 */
benchmark.Button.prototype.setColor = function(clr) {
